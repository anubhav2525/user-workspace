...
export const CustomerNav = () => {
  return (
    <div className="flex flex-col px-4 py-2 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
      <div className="flex items-center flex-1 space-x-4">
        <h5>
          <span className="text-gray-500 text-xs sm:text-sm">
            All Customer :
          </span>
          <span className="dark:text-white text-sm sm:text-md"> 123456</span>
        </h5>
      </div>
